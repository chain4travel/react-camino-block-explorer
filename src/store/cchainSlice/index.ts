        ...
        builder
            ...
            .addCase(fetchNextTransactionDetails.fulfilled, (state, { payload }) => {
                if (payload && payload.length > 0) {
                    ...
                    state.transactionsNavigation = [...state.transactionsNavigation, ...res]
                    while (state.transactionsNavigation.length > 100)
...
export const getCchainOverreview = (state: RootState) => state.cchain.ChainOverview
...
export const getCBlockDetailStatus = (state: RootState) => state.cchain.loadBlockDetial
...
export const getNextPrevTx = (state: RootState) => state.cchain.transactionsNavigation

export const getNextPrevStatus = (state: RootState) => state.cchain.loadNextPrevStatus
