                                        ...
                                        >
                                            ...
                                            dataStatistics !== undefined ? (
                                                <>
                                                    <Grid xs={12} md={6}>
                                                        {typeStatistic ===
                                                        typeBlockchainDataChart.DAILY_TRANSACTIONS ? (
                                                            <Text>
                                                                Highest number of{' '}
                                                                {dataStatistics.highestValue}{' '}
                                                                transactions on{' '}
                                                          ...
                                                          typeBlockchainDataChart.UNIQUE_ADRESSES ? (
                                                            <Text>
                                                                Highest increase of{' '}
                                                                {dataStatistics.highestValue} new
                                                          ...
                                                          typeBlockchainDataChart.ACTIVE_ADDRESSES ? (
                                                            <Text>
                                                                Highest number of{' '}
                                                                {dataStatistics.highestValue}{' '}
                                                                addresses on{' '}
                                                    ...
                                                    <Grid xs={12} md={6}>
                                                        ...
                                                        typeBlockchainDataChart.DAILY_TRANSACTIONS ? (
                                                          ...
                                                          typeBlockchainDataChart.UNIQUE_ADRESSES ? (
                                                            <Text>
                                                                Lowest increase of{' '}
                                                                {dataStatistics.lowestValue} new
                                                                addresses was recorded on{' '}
                                                                {`${moment(startDate).format(
                                                                    'dddd, MMMM DD, YYYY',
                                                                )}`}
